...
// ULTRA SHORT
static const uint16_t eepromBowdenLenDefault = 1252; //!< Default bowden length (~90 mm)
// SHORT
...
static const uint16_t eepromBowdenLenMinimum = 1125u; //!< Minimum bowden length (~85 mm)
